...
module FeatureSpecHelper
  ...
  def create_role_privileges(role, privileges_created)
    privileges_created.each do |privilege|
      Roleprivilege.create(role_id: role.id, privilege_id: privilege.id)
    end
  end

  def create_privileges
    @privileges_created = Privilege.create!([
