    ...
    if(@users_in_project.count > 0)
      @users_in_project.each do |u|
        ...
        if @user_project.save
          ...
          flash[:error] = "Error al intentar guardar los usuarios en este proyecto. Intentelo más tarde."
        end
      end
    else
      flash[:error] = "No se han seleccionado usuarios"
    end
